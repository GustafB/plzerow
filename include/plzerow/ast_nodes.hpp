...
struct Comparison {
    Comparison(std::unique_ptr<ASTNode> left, TOKEN op, std::unique_ptr<ASTNode> right) : _left(std::move(left)), _op(op), _right(std::move(right)) {}
...
struct Term {
    Term(std::unique_ptr<ASTNode> left, TOKEN op, std::unique_ptr<ASTNode> right) : _left(std::move(left)), _op(op), _right(std::move(right)) {}
    Term(Term&&) = default;
...
struct Binary {
    Binary(std::unique_ptr<ASTNode> left, TOKEN op, std::unique_ptr<ASTNode> right) : _left(std::move(left)), _op(op), _right(std::move(right)) {}
...
struct Factor {
    Factor(std::unique_ptr<ASTNode> left, TOKEN op, std::unique_ptr<ASTNode> right) : _left(std::move(left)), _op(op), _right(std::move(right)) {}
